...
apk_host="/home/tom/git/NetworkInfoAPI24V2/app/build/outputs/apk/app-debug.apk"
...
# Re execute the app
#$ADB_SH "am start -n \"$app_package/$app_package.$MAIN_ACTIVITY\"action.MAIN -c android.intent.category.LAUNCHER"
